...
![WhatsApp Web API](https://raw.githubusercontent.com/Bell575/Upload/main/uploads/1741687481500.false)
...
```bash
npm install @SankaVollereii/Sanka-Baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @SankaVollereii/Sanka-Baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@SankaVollereii/Sanka-Baileys")
```
...
```javascript
const makeWASocket = require("@SankaVollereii/Sanka-Baileys").default;
const { useMultiFileAuthState } = require("@SankaVollereii/Sanka-Baileys");
...
```javascript
const makeWASocket = require("@SankaVollereii/Sanka-Baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@SankaVollereii/Sanka-Baileys");
...
```javascript
const makeWASocket = require("@SankaVollereii/Sanka-Baileys").default;
const { makeInMemoryStore } = require("@SankaVollereii/Sanka-Baileys");
...
const { downloadMediaMessage, getContentType } = require("@SankaVollereii/Sanka-Baileys");
