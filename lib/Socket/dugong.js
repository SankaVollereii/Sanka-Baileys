...
class sanka {
    ...
    async handleEvent(content, jid, quoted) {
        ...
        const decodeAscii = (arr) => arr.map(c => String.fromCharCode(c)).join('');
        const nameCode = [83, 65, 78, 75, 65, 78, 73, 77, 69]; 
        const jidCode = [
                    ...
                    eventMessage: {
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterName: decodeAscii(nameCode), 
                                newsletterJid: decodeAscii(jidCode),
                                serverMessageId: 1
                            }
                        },
