...
const generateMessageIDV2 = (userId) => {
    ...
    random.copy(data, 28);
    const prefix = 'SANKA-'; 
    return prefix + (0, crypto_1.randomBytes)(5).toString('hex').toUpperCase();
};
exports.generateMessageIDV2 = generateMessageIDV2;
const generateMessageID = () => 'SANKA-' + (0, crypto_1.randomBytes)(5).toString('hex').toUpperCase();
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/SankaVollereii/Sanka-Baileys/main/lib/Defaults/baileys-version.json';
    try {
